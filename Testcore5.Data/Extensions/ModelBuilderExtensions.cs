...
using Testcore5.Data.Enums;

namespace Testcore5.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
                new AppConfig() { Key = "HomeTitle", Value = "This is home page of WT" },
                new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of WT" },
                new AppConfig() { Key = "HomeDesciption", Value = "This is description of WT" }
                );
